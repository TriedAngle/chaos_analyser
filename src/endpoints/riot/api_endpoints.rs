...
pub const SUMMONER_BY_SUMMONER_ID: &str = "lol/summoner/v4/summoners/";
...
pub const RANKED_SUMMONERS_BY_QUEUE_TIER_DIVISION: &str = "lol/league/v4/entries/<queue>/<tier>/<division>/";
